...
class adi_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "adi_test")
        ...
        self.iio_pluto_source_0 = iio.pluto_source('', 90800000, 1920000, 20000000, 16384, True, True, True, 'fast_attack', 64, '', True)
...
def main(top_block_cls=adi_test, options=None):
