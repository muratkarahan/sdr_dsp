...
class adi_fm_radio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "adi_fm_radio")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.iio_pluto_source_0 = iio.pluto_source('', 90800000, 2000000, 20000000, 131072, True, True, True, 'slow_attack', 64, '', True)
...
def main(top_block_cls=adi_fm_radio, options=None):
